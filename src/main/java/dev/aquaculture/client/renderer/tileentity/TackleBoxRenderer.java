package dev.aquaculture.client.renderer.tileentity;
...
public class TackleBoxRenderer<T extends TackleBoxBlockEntity> implements BlockEntityRenderer<T> {
  ...
  private final ModelPart base, lid;
  ...
  public static LayerDefinition createLayer() {
    ...
    PartDefinition partDefinition = meshDefinition.getRoot(), lid = partDefinition.addOrReplaceChild("lid",
        CubeListBuilder.create().texOffs(0, 0).addBox(-7.0F, -3.0F, -8.0F, 14, 3, 8),
        PartPose.offset(7.0F, 12.0F, 4.0F));
